package com.example.meusestudosmvvm.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.bumptech.glide.Glide
import com.example.meusestudosmvvm.databinding.ResItemLiveBinding
import com.example.meusestudosmvvm.models.Live
import com.bumptech.glide.request.RequestOptions
import com.example.meusestudosmvvm.R
...
class MainAdapter (private val onItemClicked:(Live) -> Unit): RecyclerView.Adapter<MainViewHolder>(){
    ...
    fun setLiveList(Live:List<Live>){
